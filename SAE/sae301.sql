...
CREATE TABLE `channel` (
  ...
  `need_valid` tinyint(1) DEFAULT NULL,
...
INSERT INTO `channel` VALUES ('blabla',0),('comptabilite',1),('general',0),('informatique',1),('marketing',1);
...
CREATE TABLE `user` (
  ...
  `kick_date` datetime DEFAULT NULL,
  `kick_time` int DEFAULT NULL,
...
INSERT INTO `user` VALUES ('admin','[\"comptabilite\", \"informatique\", \"blabla\", \"general\"]',1,0,NULL,NULL,'127.0.0.1','passwd');
